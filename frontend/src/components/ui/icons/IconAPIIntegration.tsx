...
const IconAPIIntegration: React.FC<IconBaseProps> = (props) => (
    <IconBase {...props}>
        ...
        <path d="M7 8L10 11L7 14" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <line x1="13" y1="12" x2="17" y2="12" stroke="white" stroke-width="2" stroke-linecap="round" />
    </IconBase>
)
